            ...
            <div className={`flex items-center ${index % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
              <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:pl-8' : 'md:pr-8'}`}>
                <Link href={`/experience/${exp.slug}`} className="block group">
                  <div className="p-6 rounded-lg shadow-lg bg-card border border-border transition-all duration-300 ease-in-out group-hover:shadow-[0_0_20px_5px_hsl(var(--primary))] group-hover:border-primary/50">
